...
<div class="next"><a href="index_.php">></a></div>
</div>
<?php
...
?>
	...
	<p>Story:</p><div class="story" style="height:55px;"><?php echo $row['story'] ;?></div> 
<?php } ?>
<?php
  $ran=mysql_query("SELECT price.amount FROM `price` inner join movie on price.prid=movie.priceid WHERE movie.mid='m1'");
